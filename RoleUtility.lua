...
X["hero_roles"] = {
	...
	["npc_dota_hero_marci"] = {
		['carry'] = 1,
		['disabler'] = 2,      -- Grapple stun + displacement
		['durable'] = 1,       -- Guardian provides some tankiness
		['escape'] = 2,        -- Companion Run is strong escape
		['initiator'] = 3,     -- PRIMARY ROLE - Grapple + Companion Run initiation
		['jungler'] = 0,
		['nuker'] = 1,         -- Some burst with abilities + Unleash
		['support'] = 2,       -- Often played as pos 4 support
		['pusher'] = 0
	},
...
function X.CanBeMidlanerOld(hero)
	if X["hero_roles"][hero] == nil then return false end;
	return hero == "npc_dota_hero_zuus" or hero == "npc_dota_hero_templar_assassin" or hero == "npc_dota_hero_ember_spirit" or hero == "npc_dota_hero_puck"  or hero == "npc_dota_hero_primal_beast"

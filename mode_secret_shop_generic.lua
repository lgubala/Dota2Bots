...
function IsStronger(bot, enemy)
	local BPower = mutil.SafeGetEstimatedDamageToTarget(bot,true, enemy, 4.0, DAMAGE_TYPE_ALL);
	local EPower = mutil.SafeGetEstimatedDamageToTarget(enemy, true, bot, 4.0, DAMAGE_TYPE_ALL);

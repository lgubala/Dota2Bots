...
ItemModule["item_devastator"] = { "item_mystic_staff"; "item_witch_blade"; }

ItemModule["item_abyssal_blade"] = { "item_basher"; "item_sange"; "item_recipe_abyssal_blade" }
...
ItemModule["item_arcane_boots"] = { "item_boots"; "item_ring_of_basilius"; "item_recipe_arcane_boots"}
...
ItemModule["item_bfury"] = { "item_quelling_blade"; "item_cornucopia"; "item_broadsword"; "item_broadsword" ,"item_recipe_bfury"}
...
ItemModule["item_bloodstone"] = { "item_soul_booster" ; "item_voodoo_mask" ; "item_void_stone"}

ItemModule["item_bloodthorn"] = { "item_orchid"; "item_javelin"; "item_hyperstone";"item_recipe_bloodthorn" }
...
ItemModule["item_butterfly"] = { "item_talisman_of_evasion"; "item_eagle"; "item_claymore" }

ItemModule["item_crimson_guard"] = { "item_vanguard"; "item_helm_of_iron_will"; "item_recipe_crimson_guard" }

ItemModule["item_lesser_crit"] = { "item_claymore"; "item_blades_of_attack"; "item_recipe_lesser_crit" }

ItemModule["item_greater_crit"] = { "item_lesser_crit"; "item_demon_edge"; "item_recipe_greater_crit" }

ItemModule["item_dagon"] = { "item_diadem"; "item_voodoo_mask"; "item_recipe_dagon" }
...
ItemModule["item_diffusal_blade"] = { "item_blade_of_alacrity"; "item_robe"; "item_recipe_diffusal_blade" }

ItemModule["item_diffusal_blade_2"] = { "item_diffusal_blade"; "item_recipe_diffusal_blade" }

ItemModule["item_dragon_lance"] = { "item_blade_of_alacrity"; "item_belt_of_strength"; "item_recipe_dragon_lance" }

ItemModule["item_ancient_janggo"] = { "item_wind_lace"; "item_belt_of_strength"; "item_robe"; "item_recipe_ancient_janggo" }

ItemModule["item_echo_sabre"] = { "item_broadsword"; "item_ogre_axe", "item_void_stone" }

ItemModule["item_ethereal_blade"] = { "item_ghost"; "item_aether_lens","item_recipe_ethereal_blade" }

ItemModule["item_cyclone"] = { "item_wind_lace"; "item_void_stone"; "item_staff_of_wizardry"; "item_recipe_cyclone" }

ItemModule["item_skadi"] = { "item_ultimate_orb"; "item_ultimate_orb"; "item_orb_of_frost" }
...
ItemModule["item_heart"] = { "item_ring_of_tarrasque"; "item_reaver"; "item_recipe_heart" }

ItemModule["item_heavens_halberd"] = { "item_vanguard"; "item_crown"; "item_recipe_heavens_halberd"}
...
ItemModule["item_lotus_orb"] = { "item_pers"; "item_platemail"; "item_energy_booster", "item_recipe_lotus_orb" }

ItemModule["item_maelstrom"] = { "item_javelin"; "item_mithril_hammer", "item_gloves" }

ItemModule["item_magic_wand"] = { "item_branches"; "item_branches"; "item_magic_stick"; "item_recipe_magic_wand" }

ItemModule["item_manta"] = { "item_yasha"; "item_diadem"; "item_recipe_manta" }

ItemModule["item_mask_of_madness"] = { "item_lifesteal"; "item_broadsword" }
...
ItemModule["item_oblivion_staff"] = { "item_blitz_knuckles"; "item_robe"; "item_sobi_mask" }

ItemModule["item_octarine_core"] = { "item_soul_booster"; "item_tiara_of_selemene" }

ItemModule["item_orchid"] = { "item_oblivion_staff"; "item_cornucopia"; "item_recipe_orchid" }
...
ItemModule["item_pipe"] = { "item_cloak"; "item_headdress"; "item_ring_of_tarrasque"; "item_recipe_pipe" }
...
ItemModule["item_radiance"] = { "item_relic"; "item_talisman_of_evasion" }

ItemModule["item_rapier"] = { "item_relic"; "item_demon_edge" }

ItemModule["item_refresher"] = { "item_cornucopia"; "item_tiara_of_selemene"; "item_ring_of_tarrasque", "item_recipe_refresher" }
...
ItemModule["item_rod_of_atos"] = { "item_vitality_booster"; "item_staff_of_wizardry"; "item_recipe_rod_of_atos" }
...
ItemModule["item_sheepstick"] = { "item_mystic_staff"; "item_tiara_of_selemene"; "item_recipe_sheepstick" }

ItemModule["item_invis_sword"] = { "item_shadow_amulet"; "item_claymore"; "item_blitz_knuckles" }

ItemModule["item_shivas_guard"] = { "item_platemail"; "item_veil_of_discord"; "item_recipe_shivas_guard" }

ItemModule["item_silver_edge"] = { "item_invis_sword"; "item_demon_edge"; "item_recipe_silver_edge" }

ItemModule["item_basher"] = { "item_mithril_hammer"; "item_belt_of_strength"; "item_recipe_basher" }

ItemModule["item_solar_crest"] = { "item_pavise"; "item_wind_lace"; "item_crown"; "item_recipe_solar_crest" }
...
ItemModule["item_vladmir"] = { "item_ring_of_basilius"; "item_buckler"; "item_blades_of_attack"; "item_lifesteal"}
...
---------- NEW ITEM BELOW ----------------
ItemModule["item_meteor_hammer"] = { "item_crown"; "item_kaya"; "item_recipe_meteor_hammer" }
--aeon disk
...
--item_holy_locket
ItemModule["item_holy_locket"] = { "item_magic_wand"; "item_diadem"; "item_recipe_holy_locket" }
...
ItemModule["item_boots_of_bearing"] = { "item_tranquil_boots"; "item_ancient_janggo"; "item_recipe_boots_of_bearing" }
ItemModule["item_revenants_brooch"] = { "item_relic"; "item_voodoo_mask"; "item_recipe_revenants_brooch" }
ItemModule["item_harpoon"] = { "item_echo_sabre"; "item_diadem"; "item_recipe_harpoon" }
...
function ItemModule.GetEmptyInventoryAmountForWards(bot)
	local amount = 0;
	for i=0,8 do	
		local item = bot:GetItemInSlot(i);
		if item == nil or item:GetName() == "item_ward_sentry" then
			amount = amount + 1;
		end
	end
	return amount;
